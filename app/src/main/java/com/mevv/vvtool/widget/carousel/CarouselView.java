package com.mevv.vvtool.widget.carousel;
...
public class CarouselView extends RelativeLayout {
    ...
    private LoopViewPager mCarouselViewPager;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (mCarouselAdapter != null && mCarouselAdapter.getCount() <= 1
                || mInfoList != null && mInfoList.size() <= 1)
            return true;
        return super.onInterceptTouchEvent(ev);
    }

    private void initUI() {
        mCarouselViewPager = new LoopViewPager(mContext);
        mCarouselViewPager.setBoundaryCaching(true);
...
//        mCarouselViewPager.setPageTransformer(true, new RotateDownPageTransformer());
    ...
    private void initViewpager() {
        ...
        if (mCarouselPagerListener == null) {
            ...
            mCarouselViewPager.setOnPageChangeListener(mCarouselPagerListener);
        }
    ...
    private class CarouselTask extends Handler implements Runnable {
        ...
        @Override
        public void run() {
//            if (mCarouselViewPager.getCurrentItem() == mCarouselViewPager.getAdapter().getCount() - 1) {
//                mCarouselViewPager.setCurrentItem((mCarouselViewPager.getCurrentItem() + 1)
//                        % mCarouselViewPager.getAdapter().getCount(), false);
//            } else {
                mCarouselViewPager.setCurrentItem((mCarouselViewPager.getCurrentItem() + 1)
                        % mCarouselViewPager.getAdapter().getCount(), false);
//            }
